...
This connector models Oregon APACD data into the Tuva claims input layer for downstream processing and analytics.

## Pre-requisites
1. You have data from Oregon APACD
...
4. Review [sources.yml](models/sources.yml).  The table names are the same as in the [Oregon APACD data dictionary](https://www.oregon.gov/oha/HPA/ANALYTICS/APAC%20Page%20Docs/APAC-Data-Dictionary.xlsx).  If you decided to rename these tables:
...
## Database Support
This package has been tested on Redshift.
